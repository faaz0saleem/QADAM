...
export const ur: Copy = {
  ...
  shop: {
    ...
    allCategories: 'سب کچھ',
    sortNew: 'نئی چیزیں',
    sortPriceLow: 'قیمت ↑',
    sortPriceHigh: 'قیمت ↓',
    sortSaving: 'سب سے زیادہ بچت',
    loadMore: 'مزید دکھائیں',
    viewAtPartner: 'پارٹنر کے ہاں دیکھیں',
    partnerNote: 'یہ پارٹنر بیچتا ہے۔ یہاں سکے خرچ نہیں ہوتے۔',
    subtotal: 'ذیلی رقم',
  ...
  group: {
    title: 'ٹیم کی ٹوکری',
    start: 'اپنی ٹیم کے ساتھ خریدیں',
    startHint: 'آرڈر سے پہلے ٹیم کے ہر فرد کی رضامندی ضروری ہے',
    open: 'ٹیم کے جواب کا انتظار',
    waitingOn: '{{count}} افراد کا انتظار',
    waitingOnOne: '1 فرد کا انتظار',
    everyoneAgreed: 'سب راضی ہو گئے۔ آرڈر ہو گیا۔',
    approve: 'ہاں',
    approveWithoutCoins: 'ہاں، مگر میرے سکے نہیں',
    decline: 'نہیں',
    cancel: 'منسوخ کریں',
    declined: '{{name}} نے انکار کیا، اس لیے آرڈر نہیں ہوا',
    cancelled: 'منسوخ ہو گئی',
    expired: 'یہ ٹوکری ختم ہو چکی ہے',
    placed: 'آرڈر ہو گیا',
    youOpened: 'یہ آپ نے شروع کی',
    openedBy: 'یہ {{name}} نے شروع کی',
    deliverTo: '{{name}} کے پتے پر',
    saving: 'ٹیم کے ساتھ {{amount}} کی بچت',
    savingCapped: 'اس ٹوکری پر {{amount}} تک کی بچت',
    committed: 'اب تک {{amount}} پورے ہوئے',
    myCoins: 'آپ نے ڈالے',
    statusWaiting: 'ابھی فیصلہ نہیں',
    statusApproved: 'راضی',
    statusApprovedNoCoins: 'راضی، سکے نہیں',
    statusDeclined: 'انکار',
    expires: '{{when}} ختم',
    noTeam: 'پہلے ٹیم میں شامل ہوں — ٹوکری کے لیے کسی کی رضامندی درکار ہے۔',
    alreadyOpen: 'آپ کی ٹیم کی ایک ٹوکری پہلے ہی انتظار میں ہے۔',
    empty: 'ابھی کوئی ٹیم ٹوکری نہیں۔ کچھ ٹوکری میں ڈالیں اور ٹیم سے پوچھیں۔',
    coinsExplainer:
      'ہر راضی فرد اپنے سکے خرچ کرتا ہے۔ سکے کبھی ایک شخص سے دوسرے کو منتقل نہیں ہوتے۔',
  },
  team: {
    title: 'ٹیم',
